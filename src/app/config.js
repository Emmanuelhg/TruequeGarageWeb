...
export let Api = {
	...
	url: 'https://trueque-garage-web.firebaseio.com/' // YOUR FIREBASE ENDPOINT
...
nueva 
AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY
=============================================*/

export let Register = {

	url: 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
}
...
export let Login = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
}
...
export let SendEmailVerification = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
...
export let ConfirmEmailVerification = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
...
export let GetUserData = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
...
export let VerifyPasswordResetCode = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:resetPassword?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
...
export let Server = {
	...
	url:'http://localhost/marketplace-production/src/assets/img/index.php?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY',
	delete: 'http://localhost/marketplace-production/src/assets/img/delete.php?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
}
...
export let Email = {
	...
	url:'http://localhost/marketplace-production/src/assets/email/index.php?key=AIzaSyAWyboOG1t5UzdSMqb9gZX0VV-NBdBClcY'
